...
#define ACCEL_Z_MIN ((float) -335)
#define ACCEL_Z_MAX ((float) 282)
...
const float magn_ellipsoid_center[3] = {5.19871, 115.835, 368.061};
const float magn_ellipsoid_transform[3][3] = {{0.941329, -0.00215290, -0.0246393}, {-0.00215290, 0.961405, -0.00618223}, {-0.0246393, -0.00618223, 0.988929}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -5.52)
#define GYRO_AVERAGE_OFFSET_Y ((float) -13.37)
...
// Extended magn
#define CALIBRATION__MAGN_USE_EXTENDED true
const float magn_ellipsoid_center[3] = {208.471, 111.854, 98.6836};
const float magn_ellipsoid_transform[3][3] = {{0.704587, -0.100684, -0.0317434}, {-0.100684, 0.811647, -0.0211980}, {-0.0317434, -0.0211980, 0.995890}};
