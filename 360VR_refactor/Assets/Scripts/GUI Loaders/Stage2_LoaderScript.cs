 ...
 * It is attached to the Canvas of the scene `Stage2_loader.unity'
 */
public class Stage2_LoaderScript : MonoBehaviour {
    ...
    public void LoadScene(int level)
    {
        ...
        PlayerPrefs.SetInt("gridSize", gridSize.value);

        // Set visible the loading image
        loadingImage.SetActive(true);

        // Load the scene "Stage2"
